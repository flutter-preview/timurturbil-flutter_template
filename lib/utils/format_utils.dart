...
extension ExtendedString on String {
  ...
  String get formatDateDayName {
    return DateFormat("EEE, MMM MM, yyyy", 'tr').format(DateTime.parse(this));
  }
  ...
  String get formatMoney {
    return "${NumberFormat.currency(locale: 'ID').format(double.parse(this)).replaceAll("IDR", "")} ₺";
  }

  String get formatMoneyForKpi {
    return "${NumberFormat.currency(locale: 'ID').format(double.parse(this)).split(",")[0].replaceAll("IDR", "")} ₺";
  }

  String get formatNumberToOneDigit {
    return NumberFormat("#,##0").format(double.parse(this));
  }
  ...
  String get formatDateRequestAddOneDay {
    return DateFormat("dd/MM/yyyy")
        .format(DateTime.parse(this).add(const Duration(days: 1)));
  }
